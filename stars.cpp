...
Planet::Planet(GLfloat radius, GLfloat distance, GLfloat speed, GLfloat selfSpeed, Star* parentStar, GLfloat rgbClor[3]): Star(radius, distance, speed, selfSpeed, parentStar) {
	//TODO:
}
